...
const OfferRide = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.driverName || !formData.phoneNumber || !formData.seatsAvailable || !formData.travelTime || !formData.location) {
      toast({
    ...
    try {
      ...
      setTimeout(() => navigate('/find-ride'), 1500);
    } catch (error) {
      toast({
        title: "Error",
  ...
  return (
    ...
    <Label htmlFor="driverName" className="text-sm font-medium">Your Name</Label>
    <Input
    id="driverName"
    type="text"
    ...
    <Users className="h-4 w-4" /> Seats Available
    </Label>
